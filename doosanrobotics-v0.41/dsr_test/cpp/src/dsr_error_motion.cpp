...
static void thread_subscriber()
{
    ...
    ros::Subscriber subRobotError = node->subscribe("/doosan_robot/error", 100, msgRobotError_cb);
...
int main(int argc, char** argv)
{
    ...
    ///ros::Subscriber subRobotError = nh.subscribe("/doosan_robot/error", 100, msgRobotError_cb);
