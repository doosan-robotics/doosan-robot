...
int CDsrRobot::movej(float fTargetPos[NUM_JOINT], float fTargetVel, float fTargetAcc, float fTargetTime/*= 0.f*/, int nMoveMode/*= MOVE_MODE_ABSOLUTE*/, float fBlendingRadius/*= 0.f*/, int nBlendingType/*= BLENDING_SPEED_TYPE_DUPLICATE*/)             
{
    return _movej(fTargetPos, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, fBlendingRadius, nBlendingType, 0);
}
int CDsrRobot::amovej(float fTargetPos[NUM_JOINT], float fTargetVel, float fTargetAcc, float fTargetTime/*= 0.f*/, int nMoveMode/*= MOVE_MODE_ABSOLUTE*/, float fBlendingRadius/*= 0.f*/, int nBlendingType/*= BLENDING_SPEED_TYPE_DUPLICATE*/)
{
    return _movej(fTargetPos, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, fBlendingRadius, nBlendingType, 1);
}
int CDsrRobot::_movej(float fTargetPos[NUM_JOINT], float fTargetVel, float fTargetAcc, float fTargetTime, int nMoveMode, float fBlendingRadius, int nBlendingType, int nSyncType)
{  
...
int CDsrRobot::movel(float fTargetPos[NUM_JOINT], float fTargetVel[2], float fTargetAcc[2], float fTargetTime, int nMoveMode/*=MOVE_MODE_ABSOLUTE*/, int nMoveReference/*=MOVE_REFERENCE_BASE*/, float fBlendingRadius/*=0.f*/, int nBlendingType/*= BLENDING_SPEED_TYPE_DUPLICATE*/)             
{
    return _movel(fTargetPos, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, nMoveReference, fBlendingRadius, nBlendingType, 0); 
}
int CDsrRobot::amovel(float fTargetPos[NUM_JOINT], float fTargetVel[2], float fTargetAcc[2], float fTargetTime, int nMoveMode/*=MOVE_MODE_ABSOLUTE*/, int nMoveReference/*=MOVE_REFERENCE_BASE*/, float fBlendingRadius/*=0.f*/, int nBlendingType/*= BLENDING_SPEED_TYPE_DUPLICATE*/)    
{
    return _movel(fTargetPos, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, nMoveReference, fBlendingRadius, nBlendingType, 1); 
}
int CDsrRobot::_movel(float fTargetPos[NUM_JOINT], float fTargetVel[2], float fTargetAcc[2], float fTargetTime, int nMoveMode, int nMoveReference, float fBlendingRadius, int nBlendingType, int nSyncType)
{
    ros::NodeHandlePtr node = boost::make_shared<ros::NodeHandle>();  
...
int CDsrRobot::movec(float fTargetPos[2][NUM_TASK], float fTargetVel[2], float fTargetAcc[2], float fTargetTime/*= 0.f*/, int nMoveMode/*=MOVE_MODE_ABSOLUTE*/, int nMoveReference/*=MOVE_REFERENCE_BASE*/, float fBlendingRadius/*=0.f*/, int nBlendingType/*=BLENDING_SPEED_TYPE_DUPLICATE*/)
{
    return _movec(fTargetPos, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, nMoveReference, fBlendingRadius, nBlendingType, 0);
}
int CDsrRobot::amovec(float fTargetPos[2][NUM_TASK], float fTargetVel[2], float fTargetAcc[2], float fTargetTime/*= 0.f*/, int nMoveMode/*=MOVE_MODE_ABSOLUTE*/, int nMoveReference/*=MOVE_REFERENCE_BASE*/, float fBlendingRadius/*=0.f*/, int nBlendingType/*=BLENDING_SPEED_TYPE_DUPLICATE*/)
{
    return _movec(fTargetPos, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, nMoveReference, fBlendingRadius, nBlendingType, 1); 
}
int CDsrRobot::_movec(float fTargetPos[2][NUM_TASK], float fTargetVel[2], float fTargetAcc[2], float fTargetTime, int nMoveMode, int nMoveReference, float fBlendingRadius, int nBlendingType, int nSyncType)
{
    ros::NodeHandlePtr node = boost::make_shared<ros::NodeHandle>();  
...
int CDsrRobot::movejx(float fTargetPos[NUM_TASK], float fTargetVel, float fTargetAcc, float fTargetTime/*=0.f*/, int nMoveMode/*=MOVE_MODE_ABSOLUTE*/, int nMoveReference/*=MOVE_REFERENCE_BASE*/, float fBlendingRadius/*= 0.f*/, int nBlendingType/* = BLENDING_SPEED_TYPE_DUPLICATE*/, int nSolSpace/*=0*/)
{
    return _movejx(fTargetPos, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, nMoveReference, fBlendingRadius, nBlendingType, nSolSpace, 0);
}
int CDsrRobot::amovejx(float fTargetPos[NUM_TASK], float fTargetVel, float fTargetAcc, float fTargetTime/*=0.f*/, int nMoveMode/*=MOVE_MODE_ABSOLUTE*/, int nMoveReference/*=MOVE_REFERENCE_BASE*/, float fBlendingRadius/*= 0.f*/, int nBlendingType/* = BLENDING_SPEED_TYPE_DUPLICATE*/, int nSolSpace/*=0*/)
{
    return _movejx(fTargetPos, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, nMoveReference, fBlendingRadius, nBlendingType, nSolSpace, 1);
}
int CDsrRobot::_movejx(float fTargetPos[NUM_TASK], float fTargetVel, float fTargetAcc, float fTargetTime, int nMoveMode, int nMoveReference, float fBlendingRadius, int nBlendingType, int nSolSpace, int nSyncType)
{
    ros::NodeHandlePtr node = boost::make_shared<ros::NodeHandle>();  
...
int CDsrRobot::move_spiral(int nTaskAxis, float fRevolution, float fMaxRadius, float fMaxLength, float fTargetVel[2], float fTargetAcc[2], float fTargetTime/*=0.f*/, int nMoveReference/*=MOVE_REFERENCE_TOOL*/)
{
    return _move_spiral(nTaskAxis, fRevolution, fMaxRadius, fMaxLength, fTargetVel, fTargetAcc, fTargetTime, nMoveReference, 0);
}
int CDsrRobot::amove_spiral(int nTaskAxis, float fRevolution, float fMaxRadius, float fMaxLength, float fTargetVel[2], float fTargetAcc[2], float fTargetTime/*=0.f*/, int nMoveReference/*=MOVE_REFERENCE_TOOL*/)
{
    return _move_spiral(nTaskAxis, fRevolution, fMaxRadius, fMaxLength, fTargetVel, fTargetAcc, fTargetTime, nMoveReference, 1);
}
int CDsrRobot::_move_spiral(int nTaskAxis, float fRevolution, float fMaxRadius, float fMaxLength, float fTargetVel[2], float fTargetAcc[2], float fTargetTime, int nMoveReference, int nSyncType)
{
    ros::NodeHandlePtr node = boost::make_shared<ros::NodeHandle>();  
...
int CDsrRobot::movesx(float fTargetPos[MAX_SPLINE_POINT][NUM_TASK], int nPosCount, float fTargetVel[2], float fTargetAcc[2], float fTargetTime/*=0.f*/, int nMoveMode/*=MOVE_MODE_ABSOLUTE*/, int nMoveReference/*=MOVE_REFERENCE_BASE*/, int nVelOpt/*=SPLINE_VELOCITY_OPTION_DEFAULT*/)
{
    return _movesx(fTargetPos, nPosCount, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, nMoveReference, nVelOpt, 0);
}
int CDsrRobot::amovesx(float fTargetPos[MAX_SPLINE_POINT][NUM_TASK], int nPosCount, float fTargetVel[2], float fTargetAcc[2], float fTargetTime/*=0.f*/, int nMoveMode/*=MOVE_MODE_ABSOLUTE*/, int nMoveReference/*=MOVE_REFERENCE_BASE*/, int nVelOpt/*=SPLINE_VELOCITY_OPTION_DEFAULT*/)
{
    return _movesx(fTargetPos, nPosCount, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, nMoveReference, nVelOpt, 1);
}
int CDsrRobot::_movesx(float fTargetPos[MAX_SPLINE_POINT][NUM_TASK], int nPosCount, float fTargetVel[2], float fTargetAcc[2], float fTargetTime, int nMoveMode, int nMoveReference, int nVelOpt, int nSyncType)
{
    ros::NodeHandlePtr node = boost::make_shared<ros::NodeHandle>();  
...
int CDsrRobot::moveb(MOVE_POSB* fTargetPos, int nPosCount, float fTargetVel[2], float fTargetAcc[2], float fTargetTime/*=0.f*/, int nMoveMode/*=MOVE_MODE_ABSOLUTE*/, int nMoveReference/*=MOVE_REFERENCE_BASE*/)
{
    return _moveb(fTargetPos, nPosCount, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, nMoveReference, 0);
}
int CDsrRobot::amoveb(MOVE_POSB* fTargetPos, int nPosCount, float fTargetVel[2], float fTargetAcc[2], float fTargetTime/*=0.f*/, int nMoveMode/*=MOVE_MODE_ABSOLUTE*/, int nMoveReference/*=MOVE_REFERENCE_BASE*/)
{
    return _moveb(fTargetPos, nPosCount, fTargetVel, fTargetAcc, fTargetTime, nMoveMode, nMoveReference, 1);
}
int CDsrRobot::_moveb(MOVE_POSB* fTargetPos, int nPosCount, float fTargetVel[2], float fTargetAcc[2], float fTargetTime, int nMoveMode, int nMoveReference, int nSyncType)
{
    ros::NodeHandlePtr node = boost::make_shared<ros::NodeHandle>();  
