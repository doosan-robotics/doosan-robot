...
def shutdown():
    ...
    print "shutdown time!"
    print("DRL stop!!!!!")
    drl_script_stop(stop_mode=1) # STOP_TYPE_QUICK
...
if __name__ == "__main__":
    ...
    drl_script_run  = rospy.ServiceProxy('/' + ROBOT_ID + ROBOT_MODEL + '/drl/drl_start', DrlStart)
    drl_script_stop = rospy.ServiceProxy('/' + ROBOT_ID + ROBOT_MODEL + '/drl/drl_stop', DrlStop)
    ...
    res = drl_script_run(0, fileRead()) # ROBOT_SYSTEM_REAL
