...
int main(int argc, char** argv)
{
    ...
    int i=0, nRes=0; 
    ros::init(argc, argv, "dsr_test_cpp", ros::init_options::NoSigintHandler);  
    ros::NodeHandle nh("~");
    ...
    ros::ServiceClient srvMoveJoint = nh.serviceClient<dsr_msgs::MoveJoint>("/doosan_robot/motion/move_joint");
    ros::ServiceClient srvMoveLine = nh.serviceClient<dsr_msgs::MoveLine>("/doosan_robot/motion/move_line");
    ros::ServiceClient srvMoveCircle = nh.serviceClient<dsr_msgs::MoveCircle>("/doosan_robot/motion/move_circle");
