...
enum {
    ...
    OPERATION_PROGRAM_SYNTAX_ERROR,             //2015  LV2 +줄번호+상세에러

    OPERATION_PROGRAM_RUNTIME_TYPE_ERROR,       //2016  LV2 +줄번호+상세에러
    OPERATION_PROGRAM_RUNTIME_VALUE_ERROR,      //2017  LV2 +줄번호+상세에러
    OPERATION_PROGRAM_RUNTIME_RUNTIME_ERROR,    //2018  LV2 +줄번호+상세에러
    OPERATION_PROGRAM_RUNTIME_EXCEPTION,        //2019  LV2 +줄번호+상세에러
